...
const Home: NextPage = () => {
  return (
    <div className="min-h-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center p-4">
      <motion.div 
      ...
      >
        ...
        >
          <p className="text-sm text-gray-500 text-center">
            Powered by WebContainers - Run Node.js in your browser!
          </p>
        </motion.div>
      </motion.div>
    </div>
